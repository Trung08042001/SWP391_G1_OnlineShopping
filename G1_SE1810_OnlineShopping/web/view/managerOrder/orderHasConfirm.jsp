    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <jsp:include page="/view/managerOrder/header.jsp"></jsp:include>
                <!-- /#header -->
                <!-- Content -->
                <form action="/SWP391_OnlineShopping/manager/OrderHasConfirm" method="get">
                    <div class="filter">
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12"> 
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Đơn Hàng Đã Xác Nhận</h1>
                                        </div>
                                        <div class="card-body--">
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size: 17px">OrderID</th>
                                                            <th style="font-size: 17px">Name</th>
                                                            <th style="font-size: 17px">Order Date</th>
                                                            <th style="font-size: 17px">ConfirmedDate</th>
                                                            <th style="font-size: 17px">Total Money</th>

                                                            <th style="font-size: 17px">Status</th>
                                                            <th style="font-size: 17px">Activity</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 16px"><span class="name">${o.orderID}</span> </td>



                                                                <td style="font-size: 16px"><span class="name">${o.account.fullname}</span> </td>


                                                                <td style="font-size: 16px">${o.date}</td>
                                                                <td style="font-size: 16px">${o.confirmedDate}</td>
                                                                <td style="font-size: 16px"><fmt:formatNumber pattern="###,###" value="${o.totalMoney}"/></td>

                                                                <td style="font-size: 16px;color:green">${o.statusName}</td>

                                                                <td style="font-size: 16px">  
                                                                    <a href="OrderHasConfirmDetail?orderID=${o.orderID}" class="confirm">Chi tiết</a>
                                                                </td>                                                                                                          
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                    ...
                                    <div class="clearfix text-center">
                                        <ul class="pagination mx-auto justify-content-center">
                                            <li class="page-item ${indexPage==1?'disabled':''}">
                                                <a href="OrderHasConfirm?page=1" class="page-link">Trang trước</a>
                                            </li>
                                            <c:forEach begin="1" end="${endP}" var="i">
                                                <li class="page-item ${indexPage == i ?'active':''}">
                                                    <a href="OrderHasConfirm?page=${i}" class="page-link">${i}</a>
                                                </li>
                                            </c:forEach>
                                            <li class="page-item ${indexPage==endP?'disabled':''}">
                                                <a href="OrderHasConfirm?page=${endP}" class="page-link">Trang tiếp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
