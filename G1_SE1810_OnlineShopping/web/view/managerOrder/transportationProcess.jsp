    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <jsp:include page="/view/managerOrder/header.jsp"></jsp:include>
                <form action="/SWP391_OnlineShopping/manager/TransportationProcess" method="get">
                    <div class="filter">
                        <select name="filter" style="padding: 10px" onchange="this.form.submit()">  
                            <option value="transportation" ${empty param.filter or param.filter eq 'transportation' ? 'selected' : ''}>Đang Vận Chuyển</option>
                        <option value="cancel" ${param.filter eq 'cancel' ? 'selected' : ''}>Người Mua Không Nhận Hàng</option>
                    </select>
                </div> 
            </form>                <!-- Content -->
            <div class="content">
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12"> 
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Đang vận chuyển</h1>
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size: 16px">Shipper Name</th>
                                                            <th style="font-size: 16px">Phone Shipper</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                <td style="font-size: 16px">${status.index + 1}</td>
                                                                <td style="font-size: 16px"><span >${o.orderID}</span></td>

                                                                <td style="font-size: 16px"> ${o.account.fullname} </td>

                                                                <td style="font-size: 16px"><fmt:formatNumber pattern="###,###" value="${o.totalMoney}"/></td>
                                                                <td style="font-size: 16px"><span >${o.pickUpDate}</span></td>
                                                                <td style="font-size: 16px"><span >${o.shipper.account.fullname}</span></td>
                                                                <td style="font-size: 16px"><span >${o.shipper.account.phone_number}</span></td>

                                                                <td style="font-size: 16px" >  
                                                                    <c:if test="${o.status == 3}">
                                                                        <a href="/SWP391_OnlineShopping/manager/TransportationProcessDetail?orderID=${o.orderID}"  style="color: black; border-radius: 5px;padding: 10px" class="confirm">Chi tiết</a>
                                                                    </c:if>
                                                                    <c:if test="${o.status == 5}">
                                                                        <a  href="/SWP391_OnlineShopping/manager/ManageUnTransportationDetail?orderID=${o.orderID}" style="color: black; border-radius: 5px;padding: 10px"class="confirm">Chi tiết</a>
                                                                    </c:if>
                                                                </td>                                                          
