                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Chi Tiết Đơn Hàng Đã Giao</h1>
                                        ...
                                        <div class="card">
                                            <div th:if="${order != null}" class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <a href="/SWP391_OnlineShopping/manager/ManageAcceptPaymentWithShipper?orderID=${detail.orderID}" style="margin-top: 20px ;padding: 20px; background-color: green;color: white;font-size: 25PX"  class="confirm" ">Kết Toán</a>
