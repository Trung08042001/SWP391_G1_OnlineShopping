...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Chi Tiết Đơn Hàng Đã kết Toán
        </title>
                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/manager/DeliveredSuccess">Quay lại</a>
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Chi Tiết Đơn Hàng Đã Kết Toán</h1>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 17px;color: green"><span >${o.order.statusName}</span></td>
                                        ...
                                        <div class="card">
                                            <div th:if="${order != null}" class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <p><strong>Tên Khách Hàng: </strong> ${detail.account.fullname}</p>
                                                    <p><strong>Số điện thoại:</strong> ${detail.account.phone_number}</p>
                                                    <p><strong>Email:</strong> ${detail.account.email}</p>
                                                    <p><strong>Địa Chỉ:</strong> ${detail.account.address}</p>
                                                ...
                                                <div class="col-lg-2">
                                                    ...
                                                    <a   style="margin-top: 20px ;padding: 20px;color: white;font-size: 25PX"  class="confirm" >ĐÃ HOÀN TẤT </a>
