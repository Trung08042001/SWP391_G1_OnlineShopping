                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/manager/confirmOrder">Quay lại</a>
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 17px"><div class="round-img">
                                    ...
                                    <div class="center">
                                        ...
                                        <a style="margin-top: 20px ;padding: 20px; background-color: black;color: white" href="ConfirmOrder?orderID=${data.orderID}" class="confirm" onclick="showConfirmationMessage()">Xác Nhận Ngay</a>
