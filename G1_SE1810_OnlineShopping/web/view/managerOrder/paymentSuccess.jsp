    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <jsp:include page="/view/managerOrder/header.jsp"></jsp:include>
                <form action="/SWP391_OnlineShopping/manager/PaymentSuccess" method="get">
                    <div class="filter">
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12"> 
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Đã Kết Toán</h1>
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size: 15px">ORDERID</th>
                                                            <th style="font-size: 15px">Payment Date</th>
                                                            <th style="font-size: 15px">Shipper Name</th>
                                                            <th style="font-size: 15px">Phone Shipper</th>
                                                            <th style="font-size: 15px">Total Money</th>

                                                            <th style="font-size: 15px">Status</th>

                                                            <th style="font-size: 15px">Activity</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 15px"><span >${o.orderID}</span></td>
                                                                <td style="font-size: 15px"><span >${o.payment_at}</span></td>
                                                                <td style="font-size: 15px"><span >${o.shipper.account.fullname}</span></td>
                                                                <td style="font-size: 15px"><span >${o.shipper.account.phone_number}</span></td>
                                                                <td style="font-size: 15px"><fmt:formatNumber pattern="###,###" value="${o.totalMoney}"/></td>
                                                                ...
                                                                <td style="font-size: 17px" >  
                                                                    <a href="/SWP391_OnlineShopping/manager/PaymentSuccessDetail?orderID=${o.orderID}" class="confirm">Chi Tiết</a>
                                                                </td>                                                          
