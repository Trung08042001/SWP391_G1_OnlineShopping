                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/manager/OrderHasConfirm">Quay lại</a>
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Chi Tiết Đơn Hàng Đã Xác Nhận</h1>
