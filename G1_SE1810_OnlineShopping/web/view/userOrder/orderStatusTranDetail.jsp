        ...
        <div id="right-panel" class="right-panel">
            ...
            <jsp:include page="/view/managerOrder/header.jsp"></jsp:include>
                ...
                <a style=" display: inline-block;
                   ...
                   border-radius: 5px;
                   transition: background-color 0.3s;"href="/SWP391_OnlineShopping/order/OrderStatus">Quay lại</a>
            ...
            <c:if test="${not empty listO}">
                ...
                <div class="content">
                    <div class="animated fadeIn">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 15px"> <span >${o.product.productName} - ${o.product.size.size}</span> </td>
                                                                <td style="font-size: 15px"><fmt:formatNumber pattern="###,###" value="${o.oprice}"/></td>

                                                                <td style="font-size: 15px"><span >${o.order.date}</span></td>
                                                                <td style="font-size: 15px"><span >${o.order.confirmedDate}</span></td>
                                                                <td style="font-size: 15px"><span >${o.order.pickUpDate}</span></td>
                                ...
                                <div class="card">
                                    <div th:if="${order != null}" class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <p><strong>Hình thức thanh toán : </strong> ${detail.paymentMethod}</p>
                        ...
                        <div class="center">
                            <h4>Tổng Tiền: </h4>
                            <h2 style="padding-top: 10px"><fmt:formatNumber pattern="###,###" value="${detail.totalMoney}"/>đ</h2>
