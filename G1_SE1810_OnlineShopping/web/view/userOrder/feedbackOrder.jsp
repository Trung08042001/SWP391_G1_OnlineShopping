                ...
                <div class="content">
                    ...
                    <div class="orders">
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-body">
                                    <h2 style="text-align: center" >Đánh giá chất lượng sản phẩm và dịch vụ</h2>                    
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        <h4 ><a  style="background-color: #428bca ; color: black;padding: 5px ;border-radius: 5px" href="/SWP391_OnlineShopping/order/OrderSuccess">
                                                <img src="/SWP391_OnlineShopping/assets/img/back.png" height="20px" width="20px" alt="alt"/>Trở lại </a></h4>
                                    </div>
                                    <div class="form-group">
                                    </div>
                                    <div class="card-body--">
                                        <form action="FeedbackOrder" method="post" class="modern-form">
                                            <div class="form-group">
                                                <label for="feedback">${data.product.productName} </label>
                                            </div>
                                            <div class="card-body">
                                                <img src="/SWP391_OnlineShopping/assets/imageproduct/${data.product.image} " height="300px" width="200px" alt="alt"/> 
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden"name="id" value="${data.order.account.id}" >
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="feedback" name="content" rows="4" cols="50"></textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="rating">Rate Start (1-5):</label>
                                                <div class="rating">
                    ...
                    <script>
                        ...
                        // Lấy giá trị của orderID từ URL
                        var urlParams = new URLSearchParams(window.location.search);
                        var orderID = urlParams.get('orderID');

                        // Kiểm tra nếu orderID không rỗng
                        if (orderID) {
                            var encodedOrderID = encodeURLParam(orderID);
                            var url = `http://localhost:9999/SWP391_OnlineShopping/order/FeedbackOrder?orderID=${encodedOrderID}`;
                            console.log(url); // In ra URL đã mã hóa
                        } else {
