    ...
    <body>
        ...
        <jsp:include page="/view/common/menu.jsp"></jsp:include>
            ...
            <div class="container-fluid pt-5">
                ...
                <form action="forgot-password" method="post" onsubmit="return confirm('Vui lòng đợi 5s ');">

                    <div class="input-group">
                        <input class="input--style-3" type="text" placeholder="Email" name="email" required>
                    </div>                <div style=" color: #a94442; padding: 10px; border-radius: 5px;">
                        <strong>${requestScope.text}</strong>
                </div>
                <div style="text-align: center;padding-top: 20px ;">
                    <button style="color: white;background-color:black;" type="submit">Xác nhận</button>
                </div><br/>
            </form>
