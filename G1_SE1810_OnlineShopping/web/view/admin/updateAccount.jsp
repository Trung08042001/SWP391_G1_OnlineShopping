                    ...
                    <form action="edit" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <label>Email</label>
                                <input value="${Detailacc.email}" name="email" type="text" class="form-control" readonly required>
                            </div>

                            <div class="form-group">
                                <label>Mật khẩu</label>
                                <input value="${Detailacc.password}" name="password" type="password" class="form-control" readonly  required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="${Detailacc.phone_number}" name="phone_number" type="text" class="form-control" readonly required>
                            </div>
                            <div class="form-group">
                                <label>Giới Tính</label>
                                <div class="col-sm-9 text-secondary">
                                    <label style="color: black" ><input type="radio" id="male" name="gender" value="1" ${Detailacc.gender ==true?"checked":""} readonly="">Male</label>
                                    <label style="color: black;padding-left: 50px"><input type="radio" id="female" name="gender" value="0" ${Detailacc.gender == false?"checked":""} readonly="">Female</label>    
                                </div></div>
                            <div class="form-group">
                                <label>Địa chỉ giao hàng</label>
                                <input value="${Detailacc.address}" name="address" type="text" class="form-control" readonly required >
                            </div>                           
                            <div class="form-group">
