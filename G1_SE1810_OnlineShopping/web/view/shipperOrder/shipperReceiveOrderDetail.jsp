                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/shipper/ShipperReceiveOrder">Quay lại</a>
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h2 style="text-align: center">Chi Tiết Đơn Hàng Để Vận Chuyển</h2>
                                        </div>
                                        <div class="card-body--">
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size: 16px" >OrderDate</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 20px"><span >${o.order.date}</span></td>
                                    ...
                                    <div class="center">
                                        <h4>Tổng Tiền: </h4>
                                        <h2 style="padding-top: 10px"><fmt:formatNumber pattern="###,###" value="${data.totalMoney}"/></h2>
                                        <a style="margin-top: 20px ;padding: 20px; background-color: black;color: white" href="/SWP391_OnlineShopping/ShipperAcceptOrder?shipperID=${shipperID}&orderID=${data.orderID}" class="confirm" onclick="showConfirmationMessage()">Nhận Giao Hàng Ngay</a>
