...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Shipper - Chi Tiết Đơn Đã Kết Toán</title>
                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/shipper/PaymentSuccess">Quay lại</a>
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h2 style="text-align: center" >Chi Tiết Đơn Đã Kết Toán</h2>
                                        </div>
                                        <div class="card-body--">
                                    ...
                                    <div class="center">
                                        ...
                                        <a style="margin-top: 20px ;padding: 20px; background-color: green;color: white;font-size: 25PX"  class="confirm">Đã Kết Toán</a>
                                    </div> 
                                </div>
                            </div>
                        </div>
