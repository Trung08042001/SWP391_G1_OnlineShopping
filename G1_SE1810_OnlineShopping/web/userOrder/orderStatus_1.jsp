    ...
    <body>
        ...
        <div id="right-panel" class="right-panel">
            ...
            <jsp:include page="/view/managerOrder/header.jsp"></jsp:include>
                ...
                <form action="/SWP391_OnlineShopping/order/OrderStatus" method="get">
                    <div class="filter">
                        <select name="filter" style="padding: 10px" onchange="this.form.submit()">  
                            <option value="confirmed" ${empty param.filter or param.filter eq 'confirmed' ? 'selected' : ''}>Đã Xác Nhận</option>
                        <option value="transportationProcess" ${param.filter eq 'transportationProcess' ? 'selected' : ''}> Đang Vận Chuyển</option>
                                                            ...
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td>  
                                                                    <c:if test="${o.order.status == 2}">
                                                                        <a  style="color: green; border-radius: 5px;padding: 10px">Chờ vận chuyển</a>
                                                                    </c:if>

                                                                    <c:if test="${o.order.status == 3}">
                                                                        <a  style="color: green; border-radius: 5px;padding: 10px">Đang vận chuyển</a>
                                                                    </c:if>
                                                                </td> 
                                                                <td>  
                                                                    <c:if test="${o.order.status == 2}">
                                                                        <a href="/SWP391_OnlineShopping/order/OrderStatusDetail?orderID=${o.order.orderID}"  style="color: black; border-radius: 5px;padding: 10px" class="confirm">Chi tiết</a>
                                                                    </c:if>
                                                                    <c:if test="${o.order.status == 3}">
                                                                        <a  href="/SWP391_OnlineShopping/order/OrderStatusTranDetail?orderID=${o.order.orderID}" style="color: green; border: 2px solid green; border-radius: 5px;padding: 10px">Chi tiết</a>
                                                                    </c:if>
                                                                </td>                                                          
