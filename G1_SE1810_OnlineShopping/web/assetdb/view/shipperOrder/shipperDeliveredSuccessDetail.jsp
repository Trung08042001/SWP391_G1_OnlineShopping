...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Shipper - Chi Tiết Đơn Đã Giao</title>
                ...
                <div class="content">
                    ...
                    <div class="animated fadeIn">
                        ...
                        <a style=" display: inline-block;
                           ...
                           border-radius: 5px;
                           transition: background-color 0.3s;"href="/SWP391_OnlineShopping/shipper/ShipperDeliveredSuccess">Quay lại</a>
                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h2 style="text-align: center" >Chi Tiết Đơn Đã Giao</h2>
                                        </div>
                                        <div class="card-body--">
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size:16px;">deliveryDate</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 20px"><span >${o.order.deliveryDate}</span></td>
                                                                <td style="font-size: 20px;color:green"><span >${detail.statusName}</span></td>
                                    ...
                                    <div class="center">
                                        ...
                                        <a style="margin-top: 20px ;padding: 20px; background-color: green;color: white;font-size: 25PX"  class="confirm">Chưa kết toán</a>
                                    </div> 
                                </div>
                            </div>
                        </div>
