                ...
                <div class="content">
                    <div class="animated fadeIn">
                        <div class="confirmation-message">
                            <h3>Cảm ơn bạn đã đặt hàng. Chúng tôi đang xem xét đơn hàng của bạn.</h3>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <c:forEach items="${listO}" var="o" varStatus="loop">
                                                            ...
                                                            <c:if test="${loop.first or o.order.orderID != listO[loop.index - 1].order.orderID}">
                                                                ...
                                                                <tr class="group-row">
                                                                    <td colspan="9" style="color: red;font-size: 17px">Mã Đơn hàng ${o.order.orderID} - Tổng Tiền : <fmt:formatNumber pattern="###,###" value="${o.order.totalMoney}"/>đ</td>
                                                                </tr>
                                                            </c:if>
                                                            ...
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td>#${o.order.date}</td>
                                                                <td>  
                                                                    <a href="DeleteOrderDetail?orderDetailID=${o.orderDetailID}" class="cancel" >Hủy Đơn</a>
                                    ...
                                    <div class="clearfix text-center">
                                        <ul class="pagination mx-auto justify-content-center">
                                            <li class="page-item ${indexPage==1?'disabled':''}">
                                                <a href="WaitConfirmation?page=1" class="page-link">Trang trước</a>
                                            </li>
                                            <c:forEach begin="1" end="${endP}" var="i">
                                                <li class="page-item ${indexPage==i?'active':''}">
                                                    <a href="WaitConfirmation?page=${i}" class="page-link">${i}</a>
                                                </li>
                                            </c:forEach>
                                            <li class="page-item ${indexPage==endP?'disabled':''}">
                                                <a href="hWaitConfirmation?page=${endP}" class="page-link">Trang tiếp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
