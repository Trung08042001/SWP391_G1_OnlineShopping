            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <h1 style="text-align: center;padding-top: 30px">
                        <img src="/SWP391_OnlineShopping/assets/img/home.png" height="50px" width="50px" alt="Home Image" />

                    </h1>
                    <div class="panel panel-teal panel-widget">
                        <div class="row no-padding" >
                            <a style="padding-left: 200px" href="AdminAccount" class="widget-link">
                                <img src="/SWP391_OnlineShopping/assets/img/user.png" alt="User Image" class="widget-image" width="200px" height="200px" />
                                <h3 style="text-align: center"class="widget-title">Thành viên</h3>
                            </a>
                        </div>
                    </div>
                    <div class="panel panel-blue panel-widget">
                        <div class="row no-padding">
                            <a style="padding-left: 200px" href="Product?cid=1" class="widget-link">
                                <div class="col-sm-4 col-lg-5 widget-left">
                                    <img src="/SWP391_OnlineShopping/assets/img/product.png" alt="Product Image" class="widget-image" width="200px" height="200px" />
                                </div>
                                <h3 style="text-align: center" class="widget-title">Sản phẩm</h3>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="panel panel-teal panel-widget">
                        <div class="row no-padding" >
                            <a style="padding-left:200px " href="Category" class="widget-link">
                                <img src="/SWP391_OnlineShopping/assets/img/categories.png" alt="User Image" class="widget-image" width="200px" height="200px" />
                                <h3 style="text-align: center"class="widget-title">Danh mục</h3>
                            </a>
                        </div>                       
                    </div>
                    <div class="panel panel-teal panel-widget">
                        <div class="row no-padding" >
                            <a style="padding-left:200px " href="Brand" class="widget-link">
                                <img src="/SWP391_OnlineShopping/assets/img/brand.png" alt="User Image" class="widget-image" width="200px" height="200px" />
                                <h3 style="text-align: center"class="widget-title">Thương Hiệu</h3>
                            </a>
                        </div>                       
                    </div>
                </div>
