                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div >
                                        ...
                                        <div class="form-group">
                                            <label>Size</label>
                                            <input name="size" class="form-control" pattern="[0-9]+" title="Size phải là số không âm." required>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="col-md-7">
                                    <div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="quantity" name="quantity" pattern="[0-9]+" title="Số lượng phải là số không âm.">
                                        </div>
                                        <div class="form-group">
