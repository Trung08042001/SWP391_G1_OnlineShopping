        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" style="height: 710px;">
                    <img class="img-fluid" src="/SWP391_OnlineShopping/assets/img/smartmen.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    </div>
                </div>
                <div class="carousel-item " style="height: 710px;">
                    <img class="img-fluid" src="/SWP391_OnlineShopping/assets/img/lOGOBANNER.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    </div>
                </div>
                <div class="carousel-item " style="height: 710px;">
                    <img class="img-fluid" src="/SWP391_OnlineShopping/assets/img/slideshow_2_master01.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    </div>
                </div>
                <div class="carousel-item" style="height: 710px;">
                    <img class="img-fluid" src="/SWP391_OnlineShopping/assets/img/slideshow_1_master.webp.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
