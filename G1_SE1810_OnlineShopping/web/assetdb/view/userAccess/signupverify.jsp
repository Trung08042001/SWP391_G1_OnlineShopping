        ...
        <jsp:include page="/view/common/menu.jsp"></jsp:include>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" style="height: 210px;" >
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <h3 style="color: white" >Nhập mã để xác minh tài khoản</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid pt-5">
                <div class="text-center mb-4">
                    <h2 class="section-title px-5"><span class="px-2">Đăng kí
                            ️</span></h2>
                </div>
                <style>
                    form {
                ...
                <h3 style="color: black;text-align: center" >Chúng tôi đã gửi mã xác minh đến Email của bạn</h3>

                <form action="signupverify" method="post">
                    <div class="input-group">
                        <input class="input--style-3" type="text" value="${sessionScope.acc.email}" readonly required>
                </div>
                <div class="input-group">
