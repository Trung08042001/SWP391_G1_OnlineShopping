                        ...
                        <div class="orders">
                            <div class="row">
                                <div class="col-xl-12"> 
                                    <div class="card">
                                        <div class="card-body">
                                            <h1 style="text-align: center">Đơn Đã Giao</h1>
                                                ...
                                                <table class="table ">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="font-size: 15px">Delivery Date</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 15px"> ${o.account.fullname} </td>

                                                                <td style="font-size: 15px"><span >${o.deliveryDate}</span></td>
                                                                ...
                                                                <td style="font-size: 17px" >  
                                                                    <a href="/SWP391_OnlineShopping/manager/DeliveredSuccessDetail?orderID=${o.orderID}" class="confirm">Chi Tiết</a>
                                                                </td>                                                          
                                    ...
                                    <div class="clearfix text-center">
                                        <ul class="pagination mx-auto justify-content-center">
                                            <li class="page-item ${indexPage==1?'disabled':''}">
                                                <a href="DeliveredSuccess?page=1" class="page-link">Trang trước</a>
                                            </li>
                                            <c:forEach begin="1" end="${endP}" var="i">
                                                <li class="page-item ${indexPage == i ?'active':''}">
                                                    <a href="DeliveredSuccess?page=${i}" class="page-link">${i}</a>
                                                </li>
                                            </c:forEach>
                                            <li class="page-item ${indexPage==endP?'disabled':''}">
                                                <a href="DeliveredSuccess?page=${endP}" class="page-link">Trang tiếp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
