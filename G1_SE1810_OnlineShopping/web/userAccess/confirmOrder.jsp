                            ...
                            <div class="row">
                                                    ...
                                                    <tbody>
                                                        <c:forEach items="${listO}" var="o" varStatus="status">
                                                            <tr class=" pb-0">
                                                                ...
                                                                <td style="font-size: 17px"><span class="name">${o.orderID}</span> </td>

                                                                <td><div class="round-img">
                                                                        <a href="#"><img class="rounded-circle" src="/SWP391_OnlineShopping/assets/avatar/${o.account.profile_picture}" alt="" ></a>
                                                                    </div></td>

                                                                <td style="font-size: 17px"><span class="name">${o.account.fullname}</span> </td>


                                                                <td style="font-size: 17px"><fmt:formatNumber pattern="###,###" value="${o.totalMoney}"/></td>
                                                                <td style="font-size: 17px">${o.date}</td>

                                                                <td style="font-size: 17px;color:green">${o.statusName}</td>

                                                                <td style="font-size: 17px">  
                                                                    <a href="javascript:void(0);" class="cancel" onclick="openConfirmationModal(${o.orderID})">Hủy đơn</a>
                                                                    <a href="ConfirmOrder?orderID=${o.orderID}" class="confirm" style="background-color: #00c292" onclick="showConfirmationMessage()">Xác nhận</a>
                                                                    <a href="ConfirmOrderDetail?orderID=${o.orderID}" class="confirm">Chi tiết</a>

                                                                </td>                                                          
                                                        <div class="confirmation-modal" id="confirmationModal">
                                                            <p style="color: black">Bạn có chắc chắn muốn xóa không?</p>
                                                            <button style="background-color: #00aced;color: white" onclick="confirmDeletion()">Xác nhận</button>
                                                            <button style="background-color: red;color: white" onclick="closeModal()">Hủy</button>
                                                        </div>
                                                        </tr>
                                                    </c:forEach>
                                                    </tbody>
                                    ...
                                    <div class="clearfix text-center">
                                        <ul class="pagination mx-auto justify-content-center">
                                            <li class="page-item ${indexPage==1?'disabled':''}">
                                                <a href="confirmOrder?page=1" class="page-link">Trang trước</a>
                                            </li>
                                            <c:forEach begin="1" end="${endP}" var="i">
                                                <li class="page-item ${indexPage==i?'active':''}">
                                                    <a href="confirmOrder?page=${i}" class="page-link">${i}</a>
                                                </li>
                                            </c:forEach>
                                            <li class="page-item ${indexPage==endP?'disabled':''}">
                                                <a href="confirmOrder?page=${endP}" class="page-link">Trang tiếp</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <script>
                                    ...
                                    function confirmDeletion() {
                                        var orderID = document.getElementById("confirmationModal").dataset.orderID;
                                        window.location.href = "deleteOrder?oid=" + orderID;
