...
public class DeleteOrderDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Kiểm tra và xóa order nếu cần
            request.getSession().setAttribute("successMessage", "Đã hủy đơn hàng này!");

            // Chuyển hướng về trang WaitConfirmation
            response.sendRedirect("/SWP391_OnlineShopping/order/WaitConfirmation");
        } catch (Exception e) {
            e.printStackTrace();
