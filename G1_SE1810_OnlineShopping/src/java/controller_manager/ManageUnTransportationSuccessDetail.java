 ...
 * @author Nitro
 */
public class ManageUnTransportationSuccessDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManageUnDeliveredSuccessDetail</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManageUnDeliveredSuccessDetail at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
            ...
            if (o != null && o.getStatus() == 5) {
                ...
                List<OrderDetail> listO = od.ShipperUnTransportationProcessDetail(orderID);
                ...
                request.getRequestDispatcher("/view/managerOrder/unTransportationProcessDetail.jsp").forward(request, response);
            } else {
