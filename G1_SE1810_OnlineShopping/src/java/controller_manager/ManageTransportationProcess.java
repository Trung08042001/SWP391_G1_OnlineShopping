 ...
 * @author Nitro
 */
public class ManageTransportationProcess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Order> listO = od.TransportationProcess(filter);
            request.setAttribute("listO", listO);
            request.getRequestDispatcher("/view/managerOrder/transportationProcess.jsp").forward(request, response);
        } catch (Exception e) {
