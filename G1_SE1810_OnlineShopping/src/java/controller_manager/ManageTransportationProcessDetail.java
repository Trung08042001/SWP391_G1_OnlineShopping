 ...
 * @author Nitro
 */
public class ManageTransportationProcessDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o != null && o.getStatus() == 3) {
                ...
                request.getRequestDispatcher("/view/managerOrder/transportationProcessDetail.jsp").forward(request, response);
            } else {
