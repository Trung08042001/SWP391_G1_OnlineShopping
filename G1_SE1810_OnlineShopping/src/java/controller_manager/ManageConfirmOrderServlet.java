 ...
 * @author Nitro
 */
public class ManageConfirmOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Order> listO = od.historyConfirmOrder(index);
            request.setAttribute("listO", listO);

            request.getRequestDispatcher("/view/managerOrder/confirmOrder.jsp").forward(request, response);
        } catch (Exception e) {
