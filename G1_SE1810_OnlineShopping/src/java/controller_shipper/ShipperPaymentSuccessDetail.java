 ...
 * @author Nitro
 */
public class ShipperPaymentSuccessDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShipperPaymentSuccessDetail</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShipperPaymentSuccessDetail at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o != null && o.getShipper().getShipperID() == shipperID && o.getStatus() == 4) {
                ...
                request.getRequestDispatcher("/view/shipperOrder/shipperPaymentSuccessDetail.jsp").forward(request, response);
            } else {
