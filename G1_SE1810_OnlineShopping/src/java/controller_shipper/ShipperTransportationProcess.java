 ...
 * @author Nitro
 */
public class ShipperTransportationProcess extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShipperTransportationProcess</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShipperTransportationProcess at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Order> listO = od.ShipperTransportationProcess(s.getShipperID(), index,filter);
            request.setAttribute("listO", listO);
            request.getRequestDispatcher("/view/shipperOrder/shipperTransportationProcess.jsp").forward(request, response);
        } catch (Exception e) {
