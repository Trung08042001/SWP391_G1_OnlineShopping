 ...
 * @author Nitro
 */
public class ShipperDeliveredSuccessDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShipperDeliveredSuccessDetail</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShipperDeliveredSuccessDetail at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (o != null && o.getShipper().getShipperID() == shipperID && o.getStatus() == 4) {
                // Tiếp tục xử lý
                List<OrderDetail> listO = od.ShipperDeliveredSuccessDetail(orderID);
                ...
                request.getRequestDispatcher("/view/shipperOrder/shipperDeliveredSuccessDetail.jsp").forward(request, response);
            } else {
